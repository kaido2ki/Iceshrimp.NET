...
public static class MvcBuilderExtensions
{
	...
	{
		public IMvcBuilder AddMultiFormatter()
		{
		...
		public IMvcBuilder ConfigureNewtonsoftJson()
		{
		...
		public IMvcBuilder AddModelBindingProviders()
		{
			builder.Services.AddOptions<MvcOptions>()
		...
		public IMvcBuilder AddValueProviderFactories()
		{
			builder.Services.AddOptions<MvcOptions>()
		...
		public IMvcBuilder AddApiBehaviorOptions()
		{
